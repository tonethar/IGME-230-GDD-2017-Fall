...
- A tile-based game (based on the [Pixel Artist HW](../notes/HW-pixel-artist.md))
     ...
     - [Conway's Game of Life](http://pmav.eu/stuff/javascript-game-of-life-v3.1.1/) (to do this kind of animation, you will need to utilize `window.requestAnimationFrame()` - https://developer.mozilla.org/en-US/docs/Web/API/window/requestAnimationFrame)
