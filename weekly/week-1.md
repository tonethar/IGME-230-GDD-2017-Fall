# Week 1 Notes
## Overview
Welcome to IGME-230 Web Site Design & Implementation! There is more to this course than the title implies, as we will be doing a lot more than just designing and implementing web sites. 
...
* construct games that run in the web browser (these are also considered to be web applications):
