...
- In this demo, there are classes that represent the `.card` and `.card-flipped` states. These are added and removed form the card elements as needed. CSS animations then perform the transition between the 2 states.
