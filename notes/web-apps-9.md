...
- Modify the code so that the user's color choice will also be reflected in the background color of the page (conveniently, all of the colors in the &lt;select> are also CSS color keywords).
