...
3. Now add a default value to the `array` parameter - an array with the values "puppydogs", "butterflies", and "lollipops". (These default values would only be used if no value was passed in for the array parameter)
